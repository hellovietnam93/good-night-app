...
ActiveRecord::Schema[7.0].define(version: 20_230_712_130_514) do
  ...
  create_table "sleep_times", force: :cascade do |t|
    ...
    t.index %w(user_id), name: "index_sleep_times_on_user_id"
  end
  ...
  create_table "user_tokens", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index %w(token), name: "index_user_tokens_on_token", unique: true
    t.index %w(user_id), name: "index_user_tokens_on_user_id"
  end
